...
jQuery.fn.extend({
    onButtonPush: function (handler) {
        $(this).on("mousedown", handler).on("touchstart", function (e) { e.preventDefault(); handler(e); });
    }
});
/**
 * Records the progress made on a particular skill. Automatically calls `Profile.update()` when modified.
 */
var SkillState = /** @class */ (function () {
    function SkillState(id, currentLevel, failedAttempts) {
    ...
    Object.defineProperty(SkillState.prototype, "currentLevel", {
    ...
    Object.defineProperty(SkillState.prototype, "failedAttempts", {
...
var Profile = /** @class */ (function () {
    function Profile(name, skills, finishedSkill) {
        if (name === void 0) { name = ""; }
        if (skills === void 0) { skills = []; }
        if (finishedSkill === void 0) { finishedSkill = ""; }
        this._name = name;
        this.skills = skills;
    ...
    Object.defineProperty(Profile.prototype, "finishedSkill", {
        get: function () { return this._finishedSkill; },
        set: function (newValue) {
    ...
    Profile.decode = function (profileCode) {
        var params = new URLSearchParams(profileCode);
        var name = "";
        var finishedSkill = "";
        var result = [];
        var skillsFailedAttempts = Object.create(null);
    ...
    Profile.prototype.encode = function () {
        ...
        try {
            for (var _b = __values(this.skills), _c = _b.next(); !_c.done; _c = _b.next()) {
                var skill = _c.value;
    ...
    Profile.loadFromLink = function () {
        var _a;
        var params = new URLSearchParams(location.search);
        return Profile.decode(atob((_a = params.get("save")) !== null && _a !== void 0 ? _a : ""));
    };
    Object.defineProperty(Profile.prototype, "savedLink", {
        get: function () {
            var relativeLink = "load.html?save=" + btoa(this.encode());
    ...
    Profile.prototype.skillState = function (id) {
        var e_2, _a;
        try {
            for (var _b = __values(this.skills), _c = _b.next(); !_c.done; _c = _b.next()) {
                var skill = _c.value;
        ...
        var newState = new SkillState(id);
        this.skills.push(newState);
        return newState;
    };
    Object.defineProperty(Profile.prototype, "hasName", {
    ...
    Object.defineProperty(Profile.prototype, "completionValue", {
        get: function () {
            var e_3, _a;
            var finishedLevels = 0;
            var totalLevels = 0;
            try {
                for (var _b = __values(Skill.all), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var skill = _c.value;
    ...
    Object.defineProperty(Profile.prototype, "completionDescription", {
        get: function () {
    ...
    Object.defineProperty(Profile.prototype, "completionDetails", {
        get: function () {
            var e_4, _a;
            var completed = [];
            var partial = [];
            try {
                for (var _b = __values(this.skills), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var skillState = _c.value;
                    var skill = Skill.forID(skillState.id);
                    if (skill === undefined) {
                        continue;
                    }
    ...
    Object.defineProperty(Profile.prototype, "isTrivial", {
        get: function () {
    ...
    Object.defineProperty(Profile, "currentIndex", {
    ...
    Object.defineProperty(Profile, "current", {
        get: function () { return Profile.all[Profile.currentIndex]; },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Profile, "recentlyDeleted", {
        /** The most recently deleted profile, if it exists. */
        get: function () { return this._recentlyDeleted; },
        enumerable: false,
        configurable: true
    });
    Profile.add = function (profile) {
        this.all.push(profile);
        this._currentIndex = Profile.all.length - 1;
        this.update();
    };
    Profile.replaceAt = function (index, replacement) {
        this.all[index] = replacement;
        this.currentIndex = index;
        this.update();
    };
    Profile.removeCurrent = function () {
        if (!Profile.current.isTrivial) {
            Profile._recentlyDeleted = Profile.current;
        }
        if (this.all.length === 1) {
            this.all.push(new Profile(""));
        }
        this.all.splice(this.currentIndex, 1);
        this.currentIndex = 0;
        this.update();
    };
    Profile.reviveRecentlyDeleted = function () {
    ...
    Profile.each = function (action) {
        for (var i = 0; i < this.all.length; i++) {
            action(i, this.all[i]);
        }
    };
    Profile.loadAllFromStorage = function () {
        var _a, _b, _c, _d;
        var profileCodes = (_b = (_a = localStorage.getItem("rhythmGame-allProfiles")) === null || _a === void 0 ? void 0 : _a.split("\n").slice(0, -1)) !== null && _b !== void 0 ? _b : [];
        Profile.all = profileCodes.map(function (x) { return Profile.decode(x); });
        Profile._currentIndex = parseInt((_c = localStorage.getItem("rhythmGame-currentProfileIndex")) !== null && _c !== void 0 ? _c : "0");
        var deleted = Profile.decode((_d = localStorage.getItem("rhythmGame-recentlyDeletedProfile")) !== null && _d !== void 0 ? _d : "");
        Profile._recentlyDeleted = deleted.isTrivial ? null : deleted;
        if (Profile.all.length === 0) {
            Profile.all.push(new Profile());
        }
        if (Profile._currentIndex >= Profile.all.length) {
            Profile._currentIndex = 0;
        }
        this.update();
    };
    Profile.saveAllToStorage = function () {
        var e_5, _a;
        var _b, _c;
        var result = "";
        try {
            for (var _d = __values(Profile.all), _e = _d.next(); !_e.done; _e = _d.next()) {
                var profile = _e.value;
        ...
        localStorage.setItem("rhythmGame-recentlyDeletedProfile", (_c = (_b = Profile.recentlyDeleted) === null || _b === void 0 ? void 0 : _b.encode()) !== null && _c !== void 0 ? _c : "");
    };
    /**
    ...
    Object.defineProperty(Profile, "allAreTrivial", {
        get: function () {
            return Profile.all.reduce(function (a, b) { return a + b.completionValue; }, 0) === 0;
        },
        enumerable: false,
        configurable: true
    });
...
var Level = /** @class */ (function () {
    function Level(name, page, icon, description, pageTitle) {
        this.name = name;
    ...
    Level.prototype.stablePseudorandomIntegerTo = function (upperBound) {
        if (upperBound === 0) {
            return 0;
        }
        var hash = 0, i, chr;
    ...
    Object.defineProperty(Level.prototype, "pageURL", {
        get: function () {
    ...
    Object.defineProperty(Level.prototype, "isFinal", {
        get: function () {
    ...
    Object.defineProperty(Level, "current", {
        ...
        get: function () {
            ...
            return (_a = Skill.current) === null || _a === void 0 ? void 0 : _a.levels[index];
        },
        enumerable: false,
        configurable: true
    });
    ...
    Level.initializePage = function () {
        var _a;
        if (this.current === undefined) {
            assertionFailure();
        }
        Profile.loadAllFromStorage();
        document.title = ((_a = this.current.pageTitle) !== null && _a !== void 0 ? _a : this.current.name) + " - Rhythm Game";
        var exitButton = $("<div style=\"position: fixed; left: 1em; top: 1em; z-position: 1000;\" id=\"exitButton\"></div>");
        ...
        var shouldShowFinalLevel = (Level.current.index == Skill.current.levels.length - 1) && (Level.current.index == Profile.current.skillState(Skill.current.id).currentLevel);
        var finalLevel = shouldShowFinalLevel ? "<div class=\"finalLevel\"><span class=\"ui-icon ui-icon-key\"></span>&nbsp;This level completes the &quot;" + Skill.current.name + "&quot; skill!</span>" : "";
            ...
            open: function () {
                ...
                if (isMobileSafari()) {
                    ...
                    $("#badButton").button({
                        label: "Let's Go!",
                        icons: "ui-icon-check",
                    }).onButtonPush(function () { return $(_this).dialog("close"); });
                }
            }
        });
    };
    Level.showGradeSummary = function (content, passed, buttons, reset) {
        var summaryElement = "<div id=\"gradeSummary\" title=\"Your Performance\">\n            " + content + "\n        </div>";
        if (passed) {
            Level.pass();
 ...
 */
var PieceLevel = /** @class */ (function (_super) {
    __extends(PieceLevel, _super);
    function PieceLevel(data, icon) {
        var _a;
        var _this = _super.call(this, data.name, "piece", icon, data.description, data.pageTitle) || this;
        _this.tempo = (_a = data.tempo) !== null && _a !== void 0 ? _a : 80;
        _this.knownCounts = data.knownCounts;
        return _this;
    }
    Object.defineProperty(PieceLevel, "current", {
        get: function () { return Level.current; },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(PieceLevel, "currentCounts", {
        get: function () {
            var _a, _b, _c;
            return (_c = (_a = this.current.knownCounts) !== null && _a !== void 0 ? _a : (_b = Skill.current) === null || _b === void 0 ? void 0 : _b.knownCounts) !== null && _c !== void 0 ? _c : Count.all;
        },
        enumerable: false,
        configurable: true
    });
 ...
 */
var ComposedLevel = /** @class */ (function (_super) {
    __extends(ComposedLevel, _super);
    function ComposedLevel(data) {
        var _this = _super.call(this, data, "volume-on") || this;
        _this.piece = new Piece(data.timeSignature, data.notes, data.backingLoop);
        return _this;
    }
    Object.defineProperty(ComposedLevel, "current", {
        get: function () { return Level.current; },
        enumerable: false,
        configurable: true
    });
 ...
 */
var RandomLevel = /** @class */ (function (_super) {
    __extends(RandomLevel, _super);
    function RandomLevel(data) {
        var _this = _super.call(this, data, "shuffle") || this;
        _this.blocks = data.blocks;
        _this.timeSignature = data.timeSignature;
        _this.measures = data.bars;
        _this.backingLoopIndex = data.backingLoop;
        return _this;
    }
    Object.defineProperty(RandomLevel.prototype, "piece", {
        get: function () {
    ...
    Object.defineProperty(RandomLevel, "current", {
        get: function () { return Level.current; },
        enumerable: false,
        configurable: true
    });
 ...
 */
var TextLevel = /** @class */ (function (_super) {
    __extends(TextLevel, _super);
    function TextLevel(data) {
        var _a;
        var _this = _super.call(this, data.name, "text", "comment", data.description, data.pageTitle) || this;
        _this.html = data.html;
        _this.isEnd = (_a = data.isEnd) !== null && _a !== void 0 ? _a : false;
        return _this;
    }
    Object.defineProperty(TextLevel, "current", {
        get: function () { return Level.current; },
        enumerable: false,
        configurable: true
    });
 ...
 */
var QuizLevel = /** @class */ (function (_super) {
    __extends(QuizLevel, _super);
    function QuizLevel(data) {
        var _this = _super.call(this, data.name, "quiz", "help", data.description, data.pageTitle) || this;
        _this._questions = data.questions;
        return _this;
    }
    Object.defineProperty(QuizLevel.prototype, "questions", {
        get: function () {
    ...
    Object.defineProperty(QuizLevel, "current", {
        get: function () { return Level.current; },
        enumerable: false,
        configurable: true
    });
    QuizLevel.prototype.shuffle = function () {
        var e_6, _a;
        for (var i = 0; i < this._questions.length; i++) {
            var j = Math.floor(Math.random() * this._questions.length);
            var temp = this._questions[i];
            this._questions[i] = this._questions[j];
            this._questions[j] = temp;
        }
        try {
            for (var _b = __values(this._questions), _c = _b.next(); !_c.done; _c = _b.next()) {
...
function aFewOthers(one, others) {
    var allOthers = others.filter(function (x) { return x !== one; });
    var result = [];
    var resultCount = Math.min(3, allOthers.length);
    for (var i = 0; i < resultCount; i++) {
        var chosenIndex = Math.floor(Math.random() * allOthers.length);
...
var Question = /** @class */ (function () {
    function Question(data) {
        this.text = data.text;
        this._answers = data.answers.map(function (x) { return new Answer(x); });
    }
    ...
    Object.defineProperty(Question.prototype, "correctAnswer", {
        get: function () {
            return this.answers.filter(function (x) { return x.correct; })[0];
        },
        enumerable: false,
        configurable: true
    });
    Question.prototype.shuffle = function () {
        for (var i = 0; i < this._answers.length; i++) {
            var j = Math.floor(Math.random() * this._answers.length);
            var temp = this._answers[i];
            this._answers[i] = this._answers[j];
            this._answers[j] = temp;
        }
    };
    Question.noteNames = function () {
        var e_7, _a;
        var notes = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            notes[_i] = arguments[_i];
        }
        function nameQuestion(note) {
            var answers = aFewOthers(note, notes).map(function (x) { return new Answer({
                text: x.toString(),
                correct: false,
    ...
    Question.noteLengths = function (timeSignature) {
        var e_8, _a;
        var notes = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            notes[_i - 1] = arguments[_i];
        }
        function meterDescription(timeSignature) {
            return (timeSignature.isCompound ? "compound " : "") + timeSignature.inlineNotation + " time";
        }
        function lengthQuestion(note) {
            var uniqueNotes = [note];
            var existingLengths = [note.absoluteLength];
            ...
            var answers = aFewOthers(note, uniqueNotes).map(function (x) { return new Answer({
        ...
        function noteQuestion(note) {
            var choices = aFewOthers(note, notes);
            choices.push(note);
            var answers = choices.map(function (x) { return new Answer({
        ...
        var result = [];
        try {
            for (var notes_2 = __values(notes), notes_2_1 = notes_2.next(); !notes_2_1.done; notes_2_1 = notes_2.next()) {
                var note = notes_2_1.value;
            ...
            try {
                if (notes_2_1 && !notes_2_1.done && (_a = notes_2.return)) _a.call(notes_2);
            }
            finally { if (e_8) throw e_8.error; }
        }
        return result;
    };
    Question.noteRelationshipSimple = function (smaller, bigger) {
        var answerValues = [bigger.relativeLength(smaller)];
        var possibleChoices = [];
        for (var i = 2; i <= bigger.relativeLength(smaller) * 2; i++) {
            if (i === bigger.relativeLength(smaller)) {
                continue;
            }
        ...
        var answers = answerValues.map(function (x) { return new Answer({
            text: "" + x,
    ...
    Question.noteRelationship = function (smaller, bigger, others) {
        var choices = [bigger];
        var remainingOthers = others.filter(function (x) { return x.absoluteLength !== bigger.absoluteLength; });
        while (choices.length < 4 && remainingOthers.length > 0) {
            var randomIndex = Math.floor(Math.random() * remainingOthers.length);
    ...
    Question.counts = function (counts) {
        var e_9, _a;
        var nonBeatCounts = counts.filter(function (x) { return x.timing !== 0; });
        function timingQuestion(count) {
            var uniqueCounts = [count];
            var existingTimings = [count.timing];
            for (var i = 0; i < nonBeatCounts.length; i++) {
            ...
            var answers = aFewOthers(count, uniqueCounts).map(function (x) { return new Answer({
        ...
        var result = [];
        try {
            for (var nonBeatCounts_1 = __values(nonBeatCounts), nonBeatCounts_1_1 = nonBeatCounts_1.next(); !nonBeatCounts_1_1.done; nonBeatCounts_1_1 = nonBeatCounts_1.next()) {
                var count = nonBeatCounts_1_1.value;
            ...
            try {
                if (nonBeatCounts_1_1 && !nonBeatCounts_1_1.done && (_a = nonBeatCounts_1.return)) _a.call(nonBeatCounts_1);
            }
...
var Skill = /** @class */ (function () {
    ...
    Object.defineProperty(Skill.prototype, "isCompleted", {
        /** Returns true if and only if the skill represented by `id` has been completed by `Profile.current`. */
        get: function () {
            var currentLevel = Profile.current.skillState(this.id).currentLevel;
            return currentLevel >= this.levels.length;
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Skill, "all", {
        get: function () {
    ...
    Skill.forID = function (id) {
        var matches = this.all.filter(function (x) { return x.id === id; });
        return matches.length > 0 ? matches[0] : undefined;
    };
    Object.defineProperty(Skill, "current", {
    ...
    Skill.loadAll = function () {
        function newSkill(newData) {
            Skill._all.push(new Skill(newData));
        }
        var tapKeyExplanation = isMobile() ? "" : " Try using the spacebar on your keyboard to tap.";
        var clapExplanation = isMobile() ? "Use one hand for the &quot;tap&quot; button and the other for the &quot;clap&quot; button." : "Use the spacebar to tap and the &quot;" + returnKeyName() + "&quot; key to clap.";
        var w = Note.whole;
        var dw = Note.whole.dotted;
        var W = Rest.whole;
        var DW = Rest.whole.dotted;
        var h = Note.half;
        var dh = Note.half.dotted;
        var H = Rest.half;
        var DH = Rest.half.dotted;
        var q = Note.quarter;
        var dq = Note.quarter.dotted;
        var Q = Rest.quarter;
        var DQ = Rest.quarter.dotted;
        var e = Note.eighth;
        var de = Note.eighth.dotted;
        var E = Rest.eighth;
        var DE = Rest.eighth.dotted;
        var s = Note.sixteenth;
        var S = Rest.sixteenth;
        newSkill({
            id: "welcome",
            name: "Welcome!",
